...
#define trunc_dbl_precision(x, scale)                                          \
    ((double)(((x) < 0.0) ? ((int)(((x) * (scale)) - 0.5)) / (scale)           \
...
/* binar.c */
extern int binarize(unsigned char **, int *, int *, unsigned char *, const int,
                    const int, int *, const int, const int, const ROTGRIDS *,
                    const LFSPARMS *);
extern int binarize_V2(unsigned char **, int *, int *, unsigned char *,
                       const int, const int, int *, const int, const int,
                       const ROTGRIDS *, const LFSPARMS *);
extern int binarize_image(unsigned char **, int *, int *, unsigned char *,
                          const int, const int, const int *, const int,
                          const int, const int, const ROTGRIDS *, const int);
extern int binarize_image_V2(unsigned char **, int *, int *, unsigned char *,
                             const int, const int, const int *, const int,
                             const int, const int, const ROTGRIDS *);
...
/* block.c */
extern int block_offsets(int **, int *, int *, const int, const int, const int,
                         const int);
extern int low_contrast_block(const int, const int, unsigned char *, const int,
                              const int, const LFSPARMS *);
extern int find_valid_block(int *, int *, int *, int *, int *, const int,
                            const int, const int, const int, const int,
                            const int);
...
extern int get_centered_contour(int **, int **, int **, int **, int *,
                                ...
                                const int);
extern int trace_contour(int **, int **, int **, int **, int *, const int,
                         const int, const int, const int, const int, const int,
                         const int, const int, unsigned char *, const int,
                         const int);
extern int search_contour(const int, const int, const int, const int, const int,
                          const int, const int, const int, unsigned char *,
                          const int, const int);
extern int next_contour_pixel(int *, int *, int *, int *, const int, const int,
                              const int, const int, const int, unsigned char *,
                              const int, const int);
...
extern int min_contour_theta(int *, double *, const int, const int *,
                             const int *, const int);
extern void contour_limits(int *, int *, int *, int *, const int *, const int *,
                           const int);
extern void fix_edge_pixel_pair(int *, int *, int *, int *, unsigned char *,
                                const int, const int);

/* detect.c */
extern int lfs_detect_minutiae(MINUTIAE **, int **, int **, int *, int *,
                               unsigned char **, int *, int *, unsigned char *,
                               const int, const int, const LFSPARMS *);

extern int lfs_detect_minutiae_V2(MINUTIAE **, int **, int **, int **, int **,
                                  int *, int *, unsigned char **, int *, int *,
                                  unsigned char *, const int, const int,
                                  const LFSPARMS *);

/* dft.c */
extern int dft_dir_powers(double **, unsigned char *, const int, const int,
                          const int, const DFTWAVES *, const ROTGRIDS *);
...
/* getmin.c */
extern int get_minutiae(MINUTIAE **, int **, int **, int **, int **, int **,
                        int *, int *, unsigned char **, int *, int *, int *,
                        unsigned char *, const int, const int, const int,
                        const double, const LFSPARMS *);

/* imgutil.c */
extern void bits_6to8(unsigned char *, const int, const int);
extern void bits_8to6(unsigned char *, const int, const int);
extern void gray2bin(const int, const int, const int, unsigned char *,
                     const int, const int);
extern int pad_uchar_image(unsigned char **, int *, int *, unsigned char *,
                           const int, const int, const int, const int);
...
extern int search_in_direction(int *, int *, int *, int *, const int, const int,
...
/* line.c */
extern int line_points(int **, int **, int *, const int, const int, const int,
                       const int);
extern int bresenham_line_points(int **, int **, int *, const int, const int,
                                 const int, const int);
...
extern int create_link_table(int **, int **, int **, int *, int *, int *,
                             const int, const int, const MINUTIAE *,
...
extern int process_link_table(const int *, const int *, const int *, const int,
                              const int, const int, const int, MINUTIAE *,
...
extern int on_island_lake(int **, int **, int **, int **, int *,
                          ...
                          unsigned char *, const int, const int);
extern int on_hook(const MINUTIA *, const MINUTIA *, const int, unsigned char *,
                   const int, const int);
extern int is_loop_clockwise(const int *, const int *, const int, const int);
extern int process_loop(MINUTIAE *, const int *, const int *, const int *,
                        const int *, const int, unsigned char *, const int,
                        const int, const LFSPARMS *);
extern int process_loop_V2(MINUTIAE *, const int *, const int *, const int *,
                           const int *, const int, unsigned char *, const int,
                           const int, int *, const LFSPARMS *);
extern void get_loop_aspect(int *, int *, double *, int *, int *, double *,
                            const int *, const int *, const int);
extern int fill_loop(const int *, const int *, const int, unsigned char *,
                     const int, const int);
extern void fill_partial_row(const int, const int, const int, const int,
                             unsigned char *, const int, const int);
extern void flood_loop(const int *, const int *, const int, unsigned char *,
                       const int, const int);
extern void flood_fill4(const int, const int, const int, unsigned char *,
                        const int, const int);
...
extern int gen_image_maps(int **, int **, int **, int **, int *, int *,
                          ...
                          const LFSPARMS *);
extern int gen_initial_maps(int **, int **, int **, int *, const int, const int,
                            unsigned char *, const int, const int,
                            const DFTWAVES *, const ROTGRIDS *,
                            const LFSPARMS *);
...
extern int pixelize_map(int **, const int, const int, int *, const int,
                        const int, const int);
...
extern int gen_high_curve_map(int **, int *, const int, const int,
                              const LFSPARMS *);
extern int gen_imap(int **, int *, int *, unsigned char *, const int, const int,
                    const DIR2RAD *, const DFTWAVES *, const ROTGRIDS *,
                    const LFSPARMS *);
extern int gen_initial_imap(int **, int *, const int, const int,
                            ...
                            const DFTWAVES *, const ROTGRIDS *,
                            const LFSPARMS *);
extern int primary_dir_test(double **, const int *, const double *, const int *,
                            const double *, const int, const LFSPARMS *);
extern int secondary_fork_test(double **, const int *, const double *,
                               const int *, const double *, const int,
                               const LFSPARMS *);
extern void remove_incon_dirs(int *, const int, const int, const DIR2RAD *,
                              const LFSPARMS *);
extern int test_top_edge(const int, const int, const int, const int, int *,
                         const int, const int, const DIR2RAD *,
                         const LFSPARMS *);
extern int test_right_edge(const int, const int, const int, const int, int *,
                           const int, const int, const DIR2RAD *,
                           const LFSPARMS *);
extern int test_bottom_edge(const int, const int, const int, const int, int *,
                            const int, const int, const DIR2RAD *,
                            const LFSPARMS *);
extern int test_left_edge(const int, const int, const int, const int, int *,
                          const int, const int, const DIR2RAD *,
                          const LFSPARMS *);
...
extern void skip_repeated_horizontal_pair(int *, const int, unsigned char **,
                                          unsigned char **, const int,
                                          const int);
extern void skip_repeated_vertical_pair(int *, const int, unsigned char **,
                                        unsigned char **, const int, const int);
...
extern int detect_minutiae(MINUTIAE *, unsigned char *, const int, const int,
                           const int *, const int *, const int, const int,
                           const LFSPARMS *);
extern int detect_minutiae_V2(MINUTIAE *, unsigned char *, const int, const int,
                              int *, int *, int *, const int, const int,
                              const LFSPARMS *);
extern int update_minutiae(MINUTIAE *, MINUTIA *, unsigned char *, const int,
                           const int, const LFSPARMS *);
...
extern int create_minutia(MINUTIA **, const int, const int, const int,
...
int scan4minutiae(MINUTIAE *, unsigned char *, const int, const int,
                  ...
                  const int, const int, const int, const int, const int,
                  const int, const LFSPARMS *);
extern int scan4minutiae_horizontally(MINUTIAE *, unsigned char *, const int,
                                      const int, const int, const int,
                                      const int, const int, const int,
                                      const int, const LFSPARMS *);
extern int scan4minutiae_horizontally_V2(MINUTIAE *, unsigned char *, const int,
                                         const int, int *, int *, int *,
                                         const LFSPARMS *);
extern int scan4minutiae_vertically(MINUTIAE *, unsigned char *, const int,
                                    const int, const int, const int, const int,
                                    const int, const int, const int,
                                    const LFSPARMS *);
extern int rescan4minutiae_horizontally(MINUTIAE *, unsigned char *bdata,
                                        ...
                                        const int, const int, const int,
                                        const LFSPARMS *);
extern int scan4minutiae_vertically_V2(MINUTIAE *, unsigned char *, const int,
                                       const int, int *, int *, int *,
                                       const LFSPARMS *);
extern int rescan4minutiae_vertically(MINUTIAE *, unsigned char *, const int,
                                      const int, const int *, const int *,
                                      const int, const int, const int,
                                      const int, const int, const int,
                                      const int, const int, const LFSPARMS *);
extern int rescan_partial_horizontally(const int, MINUTIAE *, unsigned char *,
                                       const int, const int, const int *,
                                       const int *, const int, const int,
                                       const int, const int, const int,
                                       const int, const int, const int,
                                       const LFSPARMS *);
extern int rescan_partial_vertically(const int, MINUTIAE *, unsigned char *,
                                     const int, const int, const int *,
                                     const int *, const int, const int,
                                     const int, const int, const int, const int,
                                     const int, const int, const LFSPARMS *);
...
extern int process_horizontal_scan_minutia(MINUTIAE *, const int, const int,
                                           ...
                                           const int, const int, const int,
                                           const LFSPARMS *);
extern int process_horizontal_scan_minutia_V2(MINUTIAE *, const int, const int,
                                              const int, const int,
                                              unsigned char *, const int,
                                              const int, int *, int *, int *,
                                              const LFSPARMS *);
...
extern int adjust_high_curvature_minutia(int *, int *, int *, int *, int *,
                                         ...
                                         const int, MINUTIAE *,
                                         const LFSPARMS *);
extern int adjust_high_curvature_minutia_V2(int *, int *, int *, int *, int *,
                                            const int, const int, const int,
...
/* quality.c */
extern int gen_quality_map(int **, int *, int *, int *, int *, const int,
                           const int);
extern int combined_minutia_quality(MINUTIAE *, int *, const int, const int,
                                    const int, unsigned char *, const int,
                                    const int, const int, const double);
double grayscale_reliability(MINUTIA *, unsigned char *, const int, const int,
                             const int);
extern void get_neighborhood_stats(double *, double *, MINUTIA *,
                                   unsigned char *, const int, const int,
                                   const int);
extern int reliability_fr_quality_map(MINUTIAE *, int *, const int, const int,
                                      const int, const int, const int);

/* remove.c */
extern int remove_false_minutia(MINUTIAE *, unsigned char *, const int,
                                const int, int *, const int, const int,
                                const LFSPARMS *);
extern int remove_false_minutia_V2(MINUTIAE *, unsigned char *, const int,
                                   const int, int *, int *, int *, const int,
                                   const int, const LFSPARMS *);
extern int remove_holes(MINUTIAE *, unsigned char *, const int, const int,
                        const LFSPARMS *);
extern int remove_hooks(MINUTIAE *, unsigned char *, const int, const int,
                        const LFSPARMS *);
extern int remove_hooks_islands_lakes_overlaps(MINUTIAE *, unsigned char *,
                                               const int, const int,
                                               const LFSPARMS *);
extern int remove_islands_and_lakes(MINUTIAE *, unsigned char *, const int,
                                    const int, const LFSPARMS *);
extern int remove_malformations(MINUTIAE *, unsigned char *, const int,
                                const int, int *, const int, const int,
                                const LFSPARMS *);
extern int remove_near_invblock(MINUTIAE *, int *, const int, const int,
                                const LFSPARMS *);
extern int remove_near_invblock_V2(MINUTIAE *, int *, const int, const int,
                                   const LFSPARMS *);
extern int remove_pointing_invblock(MINUTIAE *, int *, const int, const int,
                                    const LFSPARMS *);
extern int remove_pointing_invblock_V2(MINUTIAE *, int *, const int, const int,
                                       const LFSPARMS *);
extern int remove_overlaps(MINUTIAE *, unsigned char *, const int, const int,
                           const LFSPARMS *);
extern int remove_pores(MINUTIAE *, unsigned char *, const int, const int,
                        int *, const int, const int, const LFSPARMS *);
extern int remove_pores_V2(MINUTIAE *, unsigned char *, const int, const int,
                           int *, int *, int *, const int, const int,
                           const LFSPARMS *);
extern int remove_or_adjust_side_minutiae(MINUTIAE *, unsigned char *,
                                          const int, const int,
                                          const LFSPARMS *);
extern int remove_or_adjust_side_minutiae_V2(MINUTIAE *, unsigned char *,
                                             const int, const int, int *,
                                             const int, const int,
                                             const LFSPARMS *);
...
extern int write_text_results(char *, const int, const int, const int,
                              const MINUTIAE *, int *, int *, int *, int *,
                              int *, const int, const int);
extern int write_minutiae_XYTQ(char *ofile, const int, const MINUTIAE *,
                               const int, const int);
extern void dump_map(FILE *, int *, const int, const int);
extern int drawimap(int *, const int, const int, unsigned char *, const int,
                    const int, const ROTGRIDS *, const int);
extern void drawimap2(int *, const int *, const int, const int, unsigned char *,
                      const int, const int, const double, const int, const int);
extern void drawblocks(const int *, const int, const int, unsigned char *,
                       const int, const int, const int);
extern int drawrotgrid(const ROTGRIDS *, const int, unsigned char *, const int,
                       const int, const int, const int);
extern void dump_link_table(FILE *, const int *, const int *, const int *,
                            const int, const int, const int, const MINUTIAE *);
extern int draw_direction_map(char *, int *, int *, const int, const int,
                              const int, unsigned char *, const int, const int,
                              const int);
extern int draw_TF_map(char *, int *, int *, const int, const int, const int,
                       unsigned char *, const int, const int, const int);

/* ridges.c */
extern int count_minutiae_ridges(MINUTIAE *, unsigned char *, const int,
                                 const int, const LFSPARMS *);
extern int count_minutia_ridges(const int, MINUTIAE *, unsigned char *,
                                const int, const int, const LFSPARMS *);
extern int find_neighbors(int **, int *, const int, const int, MINUTIAE *);
extern int update_nbr_dists(int *, double *, int *, const int, const int,
                            const int, MINUTIAE *);
extern int insert_neighbor(const int, const int, const double, int *, double *,
                           int *, const int);
extern int sort_neighbors(int *, const int, const int, MINUTIAE *);
extern int ridge_count(const int, const int, MINUTIAE *, unsigned char *,
                       const int, const int, const LFSPARMS *);
extern int find_transition(int *, const int, const int, const int *,
                           const int *, const int, unsigned char *, const int,
                           const int);
extern int validate_ridge_crossing(const int, const int, const int *,
                                   const int *, const int, unsigned char *,
                                   const int, const int, const int);
...
extern int minmaxs(int **, int **, int **, int *, int *, const int *,
                   const int);
...
/* xytreps.c */
extern void lfs2nist_minutia_XYT(int *, int *, int *, const MINUTIA *,
                                 const int, const int);
