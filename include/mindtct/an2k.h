...
#define AN2K_RUNTIME_DATA_DIR "/home/rodrigo/nbis/install//nbis/an2k"

#define SHORT_READ_ERR_MSG(fp)                                                 \
...
extern int do_delete(const char *, const int, const int, const int, const int,
                     ANSI_NIST *);
extern int delete_ANSI_NIST_select(const int, const int, const int, const int,
                                   ANSI_NIST *);
...
extern int delete_ANSI_NIST_subfield(const int, const int, const int,
                                     ANSI_NIST *);
extern int delete_ANSI_NIST_item(const int, const int, const int, const int,
                                 ANSI_NIST *);
...
extern int read_ANSI_NIST_tagged_record(FILE *, RECORD **, const unsigned int);
...
extern int read_ANSI_NIST_binary_image_field(FILE *, FIELD **, char *,
                                             const int, const int, int);
extern int read_ANSI_NIST_image_field(FILE *, FIELD **, char *, const int,
                                      const int,
                                      int); /* Added by MDG 03-08-05 */
...
extern int read_ANSI_NIST_field_ID(FILE *, char **, unsigned int *,
                                   unsigned int *);
extern int parse_ANSI_NIST_field_ID(unsigned char **, unsigned char *, char **,
...
extern int read_fmttext_item(FILE *, int *, int *, int *, int *, int *, int *,
                             char **);
...
extern int write_fmttext_field(FILE *, const int, const int, const ANSI_NIST *);
...
extern int get_first_grayprint(unsigned char **, int *, int *, int *, double *,
                               int *, int *, RECORD **, int *,
                               const ANSI_NIST *);

/***********************************************************************/
/* INSERT.C : INSERT ROUTINES */
extern int do_insert(const char *, const int, const int, const int, const int,
                     const char *, ANSI_NIST *);
extern int insert_ANSI_NIST_select(const int, const int, const int, const int,
                                   const char *, ANSI_NIST *);
...
extern int lookup_ANSI_NIST_field(FIELD **, int *const, const unsigned int,
                                  const RECORD *const);
...
extern int lookup_ANSI_NIST_fingerprint(RECORD **, int *const, const int,
                                        const ANSI_NIST *const);
extern int lookup_ANSI_NIST_grayprint(RECORD **, int *const, const int,
                                      const ANSI_NIST *);
...
extern int do_print(const char *, const int, const int, const int, const int,
                    ANSI_NIST *);
...
extern int substitute_ANSI_NIST_subfield(const int, const int, const int,
                                         const char *, ANSI_NIST *);
extern int substitute_ANSI_NIST_item(const int, const int, const int, const int,
                                     const char *, ANSI_NIST *);
...
extern int fingerprint2tagged_field_image(RECORD **, unsigned char *, const int,
                                          const int, const int, const int,
                                          const double, char *, const int,
                                          const int, char *);
...
extern int increment_numeric_item(const int, const int, const int, const int,
                                  ANSI_NIST *, char *);
extern int decrement_numeric_item(const int, const int, const int, const int,
                                  ANSI_NIST *, char *);
