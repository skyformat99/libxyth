...
/* The code that calls it assumed dst gets bumped, so don't assign to a local
 * variable */
...
/* In: BOZORTH3.C */
extern void bz_comp(struct xyt_struct *xyt, int *, int[][COLS_SIZE_2], int *[]);
...
extern char *get_next_file(char *, FILE *, FILE *, int *, int *, char *, int,
