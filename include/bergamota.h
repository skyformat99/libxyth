...
BGM_status BGM_remove_template(
                                struct BGM_context *ctx,
                                struct BGM_template *tpl,
                                unsigned int tpl_id
                              );
...
BGM_status BGM_template_from_xyt(
                                  char *xyt_buffer,
                                  struct BGM_template *tpl,
...
BGM_status BGM_set_match_tolerances(
                                     struct BGM_context *ctx,
                                     unsigned int x_tol,
                                     unsigned int y_tol,
...
BGM_status BGM_set_match_thresholds(
                                     struct BGM_context *ctx,
