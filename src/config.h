 ...
 *Match config*
 ...
 MATCH_MINUTIA_THRESHOLD_DFL...How many matching neighbors to consider two minutiae compatible
 MATCH_TEMPLATE_THRESHOLD_DFL..How many matching minutiae to consider two templates compatible
 MATCH_FAILURE_THRESHOLD_DFL...How many non-compatible minutiae to abort a match (0 - Do not abort)
 ...
 *DB config* -- Creation time only
 ...
 DB_PIXELS_PER_GROUP_DFL...How many x/y units will be consider in the same group.
 DB_DEGREES_PER_GROUP_DFL..How many degrees units wil be consider in the same group.

 *Template config*
 MAX_MINUTIAE_PER_TEMPLATE_DFL \__.-Implemented in template, only DFL defines are missing
